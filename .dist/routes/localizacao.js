...
router.post("/", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const BuscaId = yield prisma.dispositivo.findMany({
    ...
    // }
    try {
        const bateria_statu = yield prisma.dispositivo.update({
            where: { id: dispositivoId }, data: { bateria: Number(status_bateria) }
        });
        const dispositivo = yield prisma.dispositivo.findUnique({
            where: { id: dispositivoId }, include: { config: true }
        });
        let bateria = 15;
        if ((dispositivo === null || dispositivo === void 0 ? void 0 : dispositivo.config[0].alerta_bateria_valor) != null) {
            bateria = dispositivo === null || dispositivo === void 0 ? void 0 : dispositivo.config[0].alerta_bateria_valor;
        }
        if (Number(status_bateria) <= bateria && (dispositivo === null || dispositivo === void 0 ? void 0 : dispositivo.config[0].alerta_bateria) == true) {
            console.log("!");
        ...
        const localizacao = yield prisma.localizacao.create({
            data: {
                longitude,
                latitude,
                data_hora: new Date(),
...
;
// READ
router.get("/:dispositivoId", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { dispositivoId } = req.params;
    console.log("acionado");
    try {
        const localizacoes = yield prisma.localizacao.findMany({
...
router.put("/:id", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const localizacao = yield prisma.localizacao.update({
            where: { id: Number(id) },
            data: {
                longitude,
                latitude,
...
router.delete("/:id", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    try {
        const localizacao = yield prisma.localizacao.delete({
            where: { id: Number(id) },
        });
        res.json(localizacao);
    }
...
router.post("/historico", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
